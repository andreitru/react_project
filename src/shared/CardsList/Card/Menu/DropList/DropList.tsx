...
const LIST = [
  {As: 'li' as const, text: 'Комментарии', id: generateRandomString(), icon: ICONS.comments},
  {As: 'li' as const, text: 'Поделиться', id: generateRandomString(), icon: ICONS.share},
  {As: 'li' as const, text: 'Скрыть', id: generateRandomString(), icon: ICONS.hide},
  {As: 'li' as const, text: 'Сохранить', id: generateRandomString(), icon: ICONS.save},
  {As: 'li' as const, text: 'Пожаловаться', id: generateRandomString(), icon: ICONS.complain}
];
